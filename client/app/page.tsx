...
export default function Home() {
  ...
  const handleAddLink = async () => {
    await addLink(newLink, newLinkName, selectedFolderId);
    // Update displayedLinks after adding a new link
    const updatedFolder = folders.find(folder => folder.fid === selectedFolderId);
    if (updatedFolder) {
      setDisplayedLinks(updatedFolder.links);
    }
  };
